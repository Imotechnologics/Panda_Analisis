# -*- coding: utf-8 -*-
"""
Created on Tue Feb 21 05:29:57 2023
...
players.plot(
    x="Player", y=["FG%", "3P%", "FT%"], kind="bar", title="DIVERDSIDAD DE PUNTAJE"
)


# Extraemos las areas de Interes que estamos dispuestos a analizar
# Seleccionar las columnas relevantes
Trae_Young_OFENSIVA = Trae_Young[["Player", "G", "PTS", "FG%", "3P%", "eFG%", "FT%"]]
DeMar_DeRozan_OFENSIVA = DeMar_DeRozan[
    ["Player", "G", "PTS", "FG%", "3P%", "eFG%", "FT%"]
]
Jayson_Tatum_OFENSIVA = Jayson_Tatum[
    ["Player", "G", "PTS", "FG%", "3P%", "eFG%", "FT%"]
]
LaMelo_Ball_OFENSIVA = LaMelo_Ball[["Player", "G", "PTS", "FG%", "3P%", "eFG%", "FT%"]]
Ivica_Zubac_OFENSIVA = Ivica_Zubac[["Player", "G", "PTS", "FG%", "3P%", "eFG%", "FT%"]]
...
# Trae_Young_stadisticas = Trae_Young[['Player', 'G', 'PTS', 'FG%', '3P%', 'eFG%', 'FT%', 'TRB', 'AST', 'STL', 'BLK' ]]
# DeMar_DeRozan_estadisticas = DeMar_DeRozan[['Player', 'G', 'PTS', 'FG%', '3P%', 'eFG%', 'FT%', 'TRB', 'AST', 'STL', 'BLK']]
# Jayson_Tatum_estadisticas = Jayson_Tatum[['Player', 'G', 'PTS', 'FG%', '3P%', 'eFG%', 'FT%', 'TRB', 'AST', 'STL', 'BLK']]
# LaMelo_Ball_estadisticas = LaMelo_Ball[['Player', 'G', 'PTS', 'FG%', '3P%', 'eFG%', 'FT%', 'TRB', 'AST', 'STL', 'BLK']]
# Ivica_Zubac_estadisticas = Ivica_Zubac[['Player', 'G', 'PTS', 'FG%', '3P%', 'eFG%', 'FT%', 'TRB', 'AST', 'STL', 'BLK']]


# Configurar matplotlib para visualizaciones en la notebook
